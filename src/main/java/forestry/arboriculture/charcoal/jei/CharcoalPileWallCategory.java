...
public class CharcoalPileWallCategory extends ForestryRecipeCategory<ICharcoalPileWall> {
	...
	public CharcoalPileWallCategory(IGuiHelper helper) {
		...
		Identifier Identifier = ForestryConstants.forestry("textures/gui/jei/recipes.png");
        this.arrow = helper.createDrawable(Identifier, 0, 14, 22, 16);
		IDrawableStatic arrowAnimated = helper.createDrawable(Identifier, 22, 14, 22, 16);
		this.arrowAnimated = helper.createAnimatedDrawable(arrowAnimated, 160, StartDirection.LEFT, false);
        this.flame = helper.createDrawable(Identifier, 0, 0, 14, 14);
		IDrawableStatic flameAnimated = helper.createDrawable(Identifier, 14, 0, 14, 14);
