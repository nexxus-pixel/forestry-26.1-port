...
public class EnergyBlocks {
	...
	public static final FeatureBlockGroup<EngineBlock, EngineBlockType> ENGINES = REGISTRY.blockGroup(EngineBlock::new, EngineBlockType.VALUES).item(ItemBlockForestry::new).identifier("engine").create();
}
