...
public class ForestryItemTagsProvider {
	public static void addTags(MKTagsProvider<Item> tags) {
		...
		tags.tag(ForestryTags.Items.CRAFTING_TABLES)
			.addOptionalTag(Identifier.fromNamespaceAndPath("c", "player_workstations/crafting_tables"))
			.addOptionalTag(Identifier.fromNamespaceAndPath("c", "workbenches"))
			.addOptionalTag(Identifier.fromNamespaceAndPath("c", "workbench"))
