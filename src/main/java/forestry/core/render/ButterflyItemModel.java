...
public class ButterflyItemModel implements ItemModel {
	private final Map<IButterflySpecies, GeneticsRenderData> speciesModels;
	private final GeneticsRenderData fallback;

	public ButterflyItemModel() {
		this.speciesModels = ButterflyModelBakeCache.get();
