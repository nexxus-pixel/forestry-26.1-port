...
public class Karyotype implements IKaryotype {
	...
	private final Identifier defaultSpecies;
	private final Set<IChromosome<?>> weaklyInheritedChromosomes;
	private final Codec<IGenome> genomeCodec;

	// Used in Karyotype.Builder
	public Karyotype(ImmutableMap<IChromosome<?>, ImmutableSet<? extends IAllele>> chromosomes, ImmutableMap<IChromosome<?>, ? extends IAllele> defaultAlleles, Identifier defaultSpecies, Set<IChromosome<?>> weaklyInheritedChromosomes) {
	...
	@Override
	public Identifier getDefaultSpecies() {
	...
	public static class Builder implements IKaryotypeBuilder {
		...
		@Nullable
		private Identifier defaultSpeciesId;

		@Override
		public void setSpecies(IRegistryChromosome<? extends ISpecies<?>> species, Identifier defaultId) {
		...
		@Override
		public void set(IRegistryChromosome<?> chromosome, Identifier defaultId) {
