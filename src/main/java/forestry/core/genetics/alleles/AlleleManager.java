...
public class AlleleManager implements IAlleleManager {
	...
	// id to allele
	private final LinkedHashMap<Identifier, IAllele> allelesByName = new LinkedHashMap<>();
	private final HashMap<Identifier, IChromosome<?>> chromosomes = new HashMap<>();
	...
	public AlleleManager() {
		...
		this.alleleCodec = Identifier.CODEC.flatXmap(id -> {
		...
		this.chromosomeCodec = Identifier.CODEC.flatXmap(id -> {
	...
	@Override
	public <V extends IRegistryAlleleValue> IRegistryAllele<V> registryAllele(Identifier id, IRegistryChromosome<V> chromosome) {
		checkAlleleRegistration();
	...
	public <V> IValueAllele<V> valueAllele(V value, boolean dominant, IAlleleNaming<V> naming) {
		...
		if (valueExisting != null) {
			...
			Identifier name = naming.getName(value, dominant);
	...
	@Override
	@Nullable
	public IChromosome<?> getChromosome(Identifier id) {
	...
	@Override
	public IFloatChromosome floatChromosome(Identifier id) {
		checkChromosomeRegistration();
		return (IFloatChromosome) this.chromosomes.computeIfAbsent(id, FloatChromosome::new);
	}

	@Override
	public IIntegerChromosome intChromosome(Identifier id) {
		checkChromosomeRegistration();
		return (IIntegerChromosome) this.chromosomes.computeIfAbsent(id, IntegerChromosome::new);
	}

	@Override
	public IBooleanChromosome booleanChromosome(Identifier id) {
		checkChromosomeRegistration();
		return (IBooleanChromosome) this.chromosomes.computeIfAbsent(id, BooleanChromosome::create);
	}

	@Override
	public <V> IValueChromosome<V> valueChromosome(Identifier id, Class<V> valueClass) {
		checkChromosomeRegistration();
		return registerValueChromosome(id, valueClass, ValueChromosome::new);
	}

	@Override
	public <V extends IRegistryAlleleValue> IRegistryChromosome<V> registryChromosome(Identifier id, Class<V> valueClass) {
		checkChromosomeRegistration();
		return registerValueChromosome(id, valueClass, RegistryChromosome::new);
	}

	private <V, C extends IValueChromosome<V>> C registerValueChromosome(Identifier id, Class<V> valueClass, BiFunction<Identifier, Class<V>, C> factory) {
		@SuppressWarnings("unchecked")
