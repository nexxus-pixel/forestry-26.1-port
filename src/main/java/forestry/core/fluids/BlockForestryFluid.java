...
public class BlockForestryFluid extends LiquidBlock {
	...
	public BlockForestryFluid(FeatureFluid feature) {
		super(feature::fluid, RegistrationContext.of(p -> p.liquid().noCollision().noLootTable().replaceable()));
	...
	@Override
	protected void entityInside(BlockState pState, Level pLevel, BlockPos pPos, Entity entity, InsideBlockEffectApplier applier, boolean unknown) {
		if (this.freezing) {
