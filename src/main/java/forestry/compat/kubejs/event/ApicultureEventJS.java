...
public class ApicultureEventJS extends EventJS {
	...
	public IHiveBuilder registerCustomHive(Identifier id, IHiveGen placement, BlockState hiveState, Predicate<Holder<Biome>> isGoodBiome, Predicate<HumidityType> isGoodHumidity, Predicate<TemperatureType> isGoodTemperature, float genChance, KubeHiveDefinition.PostGenFunction postGen) {
	...
	public void registerFlowerType(Identifier id, BiPredicate<Level, BlockPos> isAcceptableFlower, KubeFlowerType.PlantRandomFlowerFunction plantRandomFlower, boolean dominant) {
		this.wrapped.registerFlowerType(id, new KubeFlowerType(isAcceptableFlower, plantRandomFlower, dominant));
	}

	public void registerBeeEffect(Identifier id, UnaryOperator<IEffectData> validateStorage, boolean combinable,
	...
	public void registerCustomActivityType(Identifier id, KubeActivityType.IsActiveFunction isActive, KubeActivityType.InactiveErrorFunction inactiveErrorFunction, LightPreference lightPreference, boolean dominant) {
