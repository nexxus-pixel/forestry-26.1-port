...
public class ButterflySpeciesType extends SpeciesType<IButterflySpecies, IButterfly> implements IButterflySpeciesType {
	...
	@Override
	public Pair<ImmutableMap<Identifier, IButterflySpecies>, IMutationManager<IButterflySpecies>> handleSpeciesRegistration(List<IForestryPlugin> plugins) {
	...
	@Override
	public void onSpeciesRegistered(ImmutableMap<Identifier, IButterflySpecies> allSpecies, IMutationManager<IButterflySpecies> mutations) {
	...
	public String getBreedingTrackerFile(@Nullable GameProfile profile) {
		return "LepidopteristTracker." + (profile == null ? "common" : profile.id());
	}
