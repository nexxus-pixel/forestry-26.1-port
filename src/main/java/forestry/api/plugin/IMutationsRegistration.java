...
public interface IMutationsRegistration {
	 ...
	 */
	IMutationBuilder add(Identifier firstParent, Identifier secondParent, float chance);
	 ...
	 */
	@Deprecated
	default IMutationBuilder add(Identifier firstParent, Identifier secondParent, int chance) {
