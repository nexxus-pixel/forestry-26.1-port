...
public interface IApicultureRegistration {
	...
	default IBeeSpeciesBuilder registerSpecies(Identifier id, String genus, String species, boolean dominant, Color outline) {
	 ...
	 */
	IBeeSpeciesBuilder registerSpecies(Identifier id, String genus, String species, boolean dominant, TextColor outline);
