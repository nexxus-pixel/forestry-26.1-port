...
public interface IFarmTypeBuilder {
	...
	default IFarmTypeBuilder addSoil(Block block) {
		return addSoilItem(block.asItem(), block.defaultBlockState());
	}
	 ...
	 */
	default IFarmTypeBuilder addSoil(Item resource, BlockState soilState) {
		return addSoilItem(resource, soilState);
	}

	IFarmTypeBuilder addSoilItem(Item resource, BlockState soilState);
	 ...
	 */
	default IFarmTypeBuilder addGermling(Item germling) {
		return addGermlingItem(germling);
	}

	IFarmTypeBuilder addGermlingItem(Item germling);
	 ...
	 */
	default IFarmTypeBuilder addProduct(Item product) {
		return addProductItem(product);
	}

	IFarmTypeBuilder addProductItem(Item product);
