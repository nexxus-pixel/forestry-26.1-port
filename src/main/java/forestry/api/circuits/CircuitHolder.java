 ...
 * @param item     The item that holds a circuit in this layout. Usually, it is a type of Electron Tube.
 * @param count    Stack size used when matching circuit items.
 * @param circuit  The circuit this item holds when inserted into the circuit layout with the given layout ID.
 */
public record CircuitHolder(String layoutId, Item item, int count, ICircuit circuit) {
