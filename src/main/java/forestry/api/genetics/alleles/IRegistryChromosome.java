 ...
 * Create an instance using {@link IAlleleManager#registryChromosome(Identifier, Class)}.
 */
public interface IRegistryChromosome<V extends IRegistryAlleleValue> extends IValueChromosome<V> {
	 ...
	 */
	void populate(ImmutableMap<Identifier, V> registry);
