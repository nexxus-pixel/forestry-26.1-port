...
public interface ISpeciesType<S extends ISpecies<I>, I extends IIndividual> extends IBreedingTrackerHandler {
	 ...
	 */
	Pair<ImmutableMap<Identifier, S>, IMutationManager<S>> handleSpeciesRegistration(List<IForestryPlugin> plugins);
	 ...
	 */
	void onSpeciesRegistered(ImmutableMap<Identifier, S> allSpecies, IMutationManager<S> mutations);
