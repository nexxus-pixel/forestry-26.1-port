...
public class BeeExploreParticle extends SingleQuadParticle {
	private final Vec3 origin;

	public BeeExploreParticle(ClientLevel world, double x, double y, double z, BlockPos destination, int color, SpriteSet sprites) {
