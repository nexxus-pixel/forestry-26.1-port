...
public class ApicultureItems {
	...
	// / APIARIST'S CLOTHES (ItemArmorApiarist pending Phase 5 armor API migration)
	public static final FeatureItem<Item> APIARIST_HELMET = REGISTRY.item("apiarist_helmet");
	public static final FeatureItem<Item> APIARIST_CHEST = REGISTRY.item("apiarist_chest");
	public static final FeatureItem<Item> APIARIST_LEGS = REGISTRY.item("apiarist_legs");
	public static final FeatureItem<Item> APIARIST_BOOTS = REGISTRY.item("apiarist_boots");

	// TOOLS (ItemScoop/ItemSmoker pending Phase 5 tool API migration)
	public static final FeatureItem<Item> SCOOP = REGISTRY.item("scoop");
	public static final FeatureItem<Item> SMOKER = REGISTRY.item("smoker");
