...
public class BeeSpecies extends Species<IBeeSpeciesType, IBee> implements IBeeSpecies {
	...
	public BeeSpecies(Identifier id, IBeeSpeciesType speciesType, IGenome defaultGenome, IBeeSpeciesBuilder builder) {
	...
	public void addTooltip(IBee individual, List<Component> tooltip) {
		...
		if (generation > 0) {
			...
			tooltip.add(Component.translatable("for.gui.beealyzer.generations", generation).withStyle(rarity.color()));
		}
