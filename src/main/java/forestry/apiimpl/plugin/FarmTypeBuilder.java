...
public class FarmTypeBuilder implements IFarmTypeBuilder {
	...
	private final ImmutableList.Builder<Item> germlings = new ImmutableList.Builder<>();
	private final ImmutableList.Builder<Item> products = new ImmutableList.Builder<>();
	...
	public FarmTypeBuilder(Identifier id, BiFunction<IFarmType, Boolean, IFarmLogic> factory, Item icon) {
		this.id = id;
	...
	@Override
	public IFarmTypeBuilder addSoilItem(Item resource, BlockState soilState) {
	...
	public IFarmTypeBuilder addSoil(ItemStack resource, BlockState soilState) {
		return addSoilItem(resource.getItem(), soilState);
	}

	@Override
	public IFarmTypeBuilder addGermlingItem(Item germling) {
	...
	public IFarmTypeBuilder addGermling(ItemStack germling) {
		return addGermlingItem(germling.getItem());
	}

	@Override
	public IFarmTypeBuilder addGermlings(Iterable<ItemStack> seedling) {
		for (ItemStack stack : seedling) {
			this.germlings.add(stack.getItem());
		}
		return this;
	}

	@Override
	public IFarmTypeBuilder addProductItem(Item product) {
