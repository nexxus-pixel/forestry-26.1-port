...
public abstract class SpeciesBuilder<T extends ISpeciesType<S, ?>, S extends ISpecies<?>, B extends ISpeciesBuilder<T, S, B>> implements ISpeciesBuilder<T, S, B> {
	...
	public SpeciesBuilder(Identifier id, String genus, String species, MutationsRegistration mutations) {
		this.id = id;
		this.genus = genus;
	...
	@Override
	public List<IMutation<S>> buildMutations(ISpeciesType<S, ?> speciesType, ImmutableMap<Identifier, S> speciesLookup) {
