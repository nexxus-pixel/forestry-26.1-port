...
public class MutationsRegistration implements IMutationsRegistration {
	...
	public MutationsRegistration(Identifier speciesId) {
		this.speciesId = speciesId;
	}

	@Override
	public IMutationBuilder add(Identifier firstParent, Identifier secondParent, float chance) {
	...
	public <S extends ISpecies<?>> List<IMutation<S>> build(ISpeciesType<S, ?> speciesType, ImmutableMap<Identifier, S> speciesLookup) {
	...
	private record MutationPair(Identifier first, Identifier second) {
	}
	...
	public static class MutationBuilder implements IMutationBuilder {
		...
		private MutationBuilder(MutationPair pair, Identifier result) {
			this.pair = pair;
			this.result = result;
		}
		...
		@Override
		public <S extends ISpecies<?>> IMutation<S> build(ISpeciesType<S, ?> speciesType, ImmutableMap<Identifier, S> speciesLookup) {
